...
then
    ...
    for i in `ls "$dir/$in"` ; do             #error aqui

      echo "este es i $i"
      echo "esta es dir actual: $dir"
      echo "nombre la actual: $in"
      echo "dir guardada: $olddir"
      if test $s = "y"
      then
        echo "with option -s"
        split_file "$i"
...
do
        ...
        case "$arg1" in
                  -r) r=y;;
                  -l) noshift=0; split_file "$2"; l=y ; mainfuction;;
                  -u) noshift=0; split_file "$2"; u=y; mainfuction;;
                   *) if test $l = "y"
                      then
                          arg1="-l"
                          noshift=1
                      ...
                      then
                        ...
                        noshift=0; sed_function $1; split_file "$2"; mainfuction;
                     fi
                    aux=1;;
                  -*) error_msg "bad option $1"; exit 1 ;;
        esac
